export const cards = [
  {
    title: 'Fiesta de ignaguración de Yendo',
    descripcion: 'Esta es la fiesta de ignaguración del boliche Yendo. Este es el único boliche donde se puede reservar en esta prueba :) Lo encontraste!',
